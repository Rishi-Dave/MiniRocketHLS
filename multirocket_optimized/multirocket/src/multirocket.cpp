...
extern "C" void multirocket_inference(
    ...
    #pragma HLS INTERFACE m_axi port=dilations_0 bundle=gmem6 depth=8
    #pragma HLS INTERFACE m_axi port=num_features_per_dilation_0 bundle=gmem7 depth=8
    #pragma HLS INTERFACE m_axi port=biases_0 bundle=gmem8 depth=10000
    #pragma HLS INTERFACE m_axi port=dilations_1 bundle=gmem9 depth=8
    #pragma HLS INTERFACE m_axi port=num_features_per_dilation_1 bundle=gmem10 depth=8
    #pragma HLS INTERFACE m_axi port=biases_1 bundle=gmem11 depth=10000
    ...
    multirocket_feature_extraction_hls(
        ...
        num_features_1,
        n_feature_per_kernel,
        (num_features_1 + num_features_0) / 2
    );
