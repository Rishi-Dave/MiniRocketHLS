...
This file was a verbatim copy of the Dec-2025 root `RESULTS.md` — it is not
just stale, it is **misplaced**: `fpga-network/` is the NetLayer / F2F
network-saturation stack (`minirocket_fused`, `pktDropper`, `udp_generator`),
but this content described single-node, host-dispatched results. Do not cite
it.

Canonical documentation: [../../README.md](../../README.md) ·
[../../docs/RESULTS.md](../../docs/RESULTS.md) (host-dispatched thread) ·
[../../docs/NETWORK_RESULTS.md](../../docs/NETWORK_RESULTS.md) (this
directory's actual thread — F2F saturation results) ·
