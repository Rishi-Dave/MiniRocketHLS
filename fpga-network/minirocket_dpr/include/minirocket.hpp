...
// DP-Reuse persists convolutions[MAX_DILATIONS][NUM_KERNELS][MAX_TIME_SERIES_LENGTH]
// in BRAM. At 8192 that is 22 MB (impossible); 512 -> 1.4 MB but 66% SLR BRAM
// caused routing congestion that failed the CMAC system clock (txoutclk -0.321 ns,
// 2026-06-08). 192 -> ~0.5 MB / ~25% SLR; fits the len-150 streaming model.
#define MAX_TIME_SERIES_LENGTH 192
