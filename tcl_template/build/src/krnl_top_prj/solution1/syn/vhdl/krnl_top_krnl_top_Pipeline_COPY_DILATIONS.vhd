...
entity krnl_top_krnl_top_Pipeline_COPY_DILATIONS is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_top_krnl_top_Pipeline_COPY_DILATIONS is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln27_fu_100_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_reg_139_pp0_iter1_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal gmem6_addr_read_reg_148 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln252_1_fu_123_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_1_fu_50 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal add_ln22_fu_106_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln252_fu_96_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln27_fu_100_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_1_fu_50 <= add_ln22_fu_106_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                gmem6_addr_read_reg_148 <= m_axi_gmem6_RDATA;
                i_reg_139 <= ap_sig_allocacmp_i;
                i_reg_139_pp0_iter1_reg <= i_reg_139;
            end if;
        end if;
    end process;
    ...
    add_ln22_fu_106_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv4_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem6_RVALID)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (m_axi_gmem6_RVALID = ap_const_logic_0);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln27_fu_100_p2)
    begin
        if (((icmp_ln27_fu_100_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    gmem6_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_gmem6_RVALID, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln27_fu_100_p2 <= "1" when (signed(zext_ln252_fu_96_p1) < signed(num_dilations)) else "0";
    local_dilations_address0 <= zext_ln252_1_fu_123_p1(3 - 1 downto 0);

    local_dilations_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            local_dilations_ce0 <= ap_const_logic_1;
        else 
            local_dilations_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    local_dilations_d0 <= gmem6_addr_read_reg_148;

    local_dilations_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            local_dilations_we0 <= ap_const_logic_1;
        else 
    ...
    m_axi_gmem6_ARLEN <= ap_const_lv32_0;
    ...
    m_axi_gmem6_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    zext_ln252_1_fu_123_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_139_pp0_iter1_reg),64));
    zext_ln252_fu_96_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),32));
end behav;
