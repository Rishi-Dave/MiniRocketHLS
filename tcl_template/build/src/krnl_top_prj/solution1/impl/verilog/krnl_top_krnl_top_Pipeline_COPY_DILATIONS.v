...
module krnl_top_krnl_top_Pipeline_COPY_DILATIONS (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [31:0] num_dilations;
input  [61:0] sext_ln252;
output  [2:0] local_dilations_address0;
output   local_dilations_ce0;
output   local_dilations_we0;
output  [31:0] local_dilations_d0;
...
reg   [3:0] i_reg_139;
reg   [3:0] i_reg_139_pp0_iter1_reg;
reg   [31:0] gmem6_addr_read_reg_148;
wire   [63:0] zext_ln252_1_fu_123_p1;
reg   [3:0] i_1_fu_50;
wire   [3:0] add_ln22_fu_106_p2;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_i;
wire   [31:0] zext_ln252_fu_96_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln27_fu_100_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln27_fu_100_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln22_fu_106_p2 = (ap_sig_allocacmp_i + 4'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (m_axi_gmem6_RVALID == 1'b0);
end
...
assign icmp_ln27_fu_100_p2 = (($signed(zext_ln252_fu_96_p1) < $signed(num_dilations)) ? 1'b1 : 1'b0);

assign local_dilations_address0 = zext_ln252_1_fu_123_p1;

assign local_dilations_d0 = gmem6_addr_read_reg_148;
...
assign zext_ln252_1_fu_123_p1 = i_reg_139_pp0_iter1_reg;

assign zext_ln252_fu_96_p1 = ap_sig_allocacmp_i;

endmodule //krnl_top_krnl_top_Pipeline_COPY_DILATIONS
