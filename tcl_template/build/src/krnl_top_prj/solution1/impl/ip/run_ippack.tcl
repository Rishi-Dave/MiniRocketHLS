...
set IPName      "krnl_top"
set Version     "1.0"
set DisplayName "Krnl_top"
set Revision    "2114355097"
...
set xo_kernel_name "krnl_top"
set xo_kernel_files {/home/rdave009/minirocket-hls/MiniRocketHLS/tcl_template/src/krnl.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/rdave009/minirocket-hls/MiniRocketHLS/tcl_template/build/src/krnl_top_prj/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/rdave009/minirocket-hls/MiniRocketHLS/tcl_template/build/src/krnl_top_prj/solution1/.debug"
set xo_hls_files_dir "/home/rdave009/minirocket-hls/MiniRocketHLS/tcl_template/build/src/krnl_top_prj/solution1/impl/ip/hls_files"
set hdl_module_list {krnl_top_flow_control_loop_pipe_sequential_init
krnl_top_flow_control_loop_pipe_sequential_init
krnl_top_flow_control_loop_pipe_sequential_init
krnl_top_flow_control_loop_pipe_sequential_init
krnl_top_flow_control_loop_pipe_sequential_init
krnl_top_flow_control_loop_pipe_sequential_init
...
krnl_top_Pipeline_7
krnl_top_Pipeline_8
krnl_top_Pipeline_COPY_INPUT
krnl_top_Pipeline_COPY_DILATIONS
krnl_top_Pipeline_COPY_BIASES
krnl_top_Pipeline_COPY_INTERCEPT
krnl_top_Pipeline_COPY_COEF_I_COPY_COEF_J
minirocket_feature_extraction_hls_Pipeline_1
apply_kernel_hls_Pipeline_CONV_LOOP
apply_kernel_hls
minirocket_feature_extraction_hls_Pipeline_PPV_LOOP
minirocket_feature_extraction_hls
apply_scaler_hls
linear_classifier_predict_hls_Pipeline_FEATURE_LOOP
linear_classifier_predict_hls_Pipeline_BINARY_FEATURE_LOOP
linear_classifier_predict_hls
krnl_top_Pipeline_COPY_OUTPUT
krnl_top
}
set kernel_xo "/home/rdave009/minirocket-hls/MiniRocketHLS/tcl_template/build/src/krnl_top_prj/solution1/impl/export.xo"
set detect_deadlock_json "krnl_top_message_dict.json"

## Variables
set Top "krnl_top"
set TopNoPrefix "krnl_top"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 time_series_input_1 W 0x0 "Data signal of time_series_input" {{0 32 time_series_input W 0 "Bit 31 to 0 of time_series_input"}}} {0x14 time_series_input_2 W 0x0 "Data signal of time_series_input" {{0 32 time_series_input W 0 "Bit 63 to 32 of time_series_input"}}} {0x1c prediction_output_1 W 0x0 "Data signal of prediction_output" {{0 32 prediction_output W 0 "Bit 31 to 0 of prediction_output"}}} {0x20 prediction_output_2 W 0x0 "Data signal of prediction_output" {{0 32 prediction_output W 0 "Bit 63 to 32 of prediction_output"}}} {0x28 coefficients_1 W 0x0 "Data signal of coefficients" {{0 32 coefficients W 0 "Bit 31 to 0 of coefficients"}}} {0x2c coefficients_2 W 0x0 "Data signal of coefficients" {{0 32 coefficients W 0 "Bit 63 to 32 of coefficients"}}} {0x34 intercept_1 W 0x0 "Data signal of intercept" {{0 32 intercept W 0 "Bit 31 to 0 of intercept"}}} {0x38 intercept_2 W 0x0 "Data signal of intercept" {{0 32 intercept W 0 "Bit 63 to 32 of intercept"}}} {0x40 scaler_mean_1 W 0x0 "Data signal of scaler_mean" {{0 32 scaler_mean W 0 "Bit 31 to 0 of scaler_mean"}}} {0x44 scaler_mean_2 W 0x0 "Data signal of scaler_mean" {{0 32 scaler_mean W 0 "Bit 63 to 32 of scaler_mean"}}} {0x4c scaler_scale_1 W 0x0 "Data signal of scaler_scale" {{0 32 scaler_scale W 0 "Bit 31 to 0 of scaler_scale"}}} {0x50 scaler_scale_2 W 0x0 "Data signal of scaler_scale" {{0 32 scaler_scale W 0 "Bit 63 to 32 of scaler_scale"}}} {0x58 dilations_1 W 0x0 "Data signal of dilations" {{0 32 dilations W 0 "Bit 31 to 0 of dilations"}}} {0x5c dilations_2 W 0x0 "Data signal of dilations" {{0 32 dilations W 0 "Bit 63 to 32 of dilations"}}} {0x64 num_features_per_dilation_1 W 0x0 "Data signal of num_features_per_dilation" {{0 32 num_features_per_dilation W 0 "Bit 31 to 0 of num_features_per_dilation"}}} {0x68 num_features_per_dilation_2 W 0x0 "Data signal of num_features_per_dilation" {{0 32 num_features_per_dilation W 0 "Bit 63 to 32 of num_features_per_dilation"}}} {0x70 biases_1 W 0x0 "Data signal of biases" {{0 32 biases W 0 "Bit 31 to 0 of biases"}}} {0x74 biases_2 W 0x0 "Data signal of biases" {{0 32 biases W 0 "Bit 63 to 32 of biases"}}} {0x7c time_series_length W 0x0 "Data signal of time_series_length" {{0 32 time_series_length W 0 "Bit 31 to 0 of time_series_length"}}} {0x84 num_features W 0x0 "Data signal of num_features" {{0 32 num_features W 0 "Bit 31 to 0 of num_features"}}} {0x8c num_classes W 0x0 "Data signal of num_classes" {{0 32 num_classes W 0 "Bit 31 to 0 of num_classes"}}} {0x94 num_dilations W 0x0 "Data signal of num_dilations" {{0 32 num_dilations W 0 "Bit 31 to 0 of num_dilations"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 m_axi_gmem1 m_axi_gmem2 m_axi_gmem3 m_axi_gmem4 m_axi_gmem5 m_axi_gmem6 m_axi_gmem7 m_axi_gmem8"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem0 {
        ...
        handshake ""
        busParams "NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 256 MAX_WRITE_BURST_LENGTH 16 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "gmem0"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_gmem5 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem5"
        param_prefix "C_M_AXI_GMEM5"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
    ...
    m_axi_gmem6 {
        ...
        data_width "32"
        port_prefix "m_axi_gmem6"
        param_prefix "C_M_AXI_GMEM6"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_control"
...
source -notrace "/home/Xilinx/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
