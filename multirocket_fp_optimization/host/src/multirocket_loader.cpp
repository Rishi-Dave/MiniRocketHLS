...
std::string MultiRocketTestbenchLoader::read_file(const std::string& filename) {
...
void MultiRocketTestbenchLoader::trim_whitespace(std::string& str) {
    str.erase(0, str.find_first_not_of(" \t\n\r\f\v"));
    str.erase(str.find_last_not_of(" \t\n\r\f\v") + 1);
}

int MultiRocketTestbenchLoader::parse_int_value(const std::string& content, const std::string& key) {
...
std::vector<int> MultiRocketTestbenchLoader::parse_int_array(const std::string& content, const std::string& key) {
...
std::vector<float> MultiRocketTestbenchLoader::parse_float_array(const std::string& content, const std::string& key) {
...
std::vector<std::vector<int>> MultiRocketTestbenchLoader::parse_2d_int_array(const std::string& content, const std::string& key) {
...
std::vector<std::vector<float>> MultiRocketTestbenchLoader::parse_2d_float_array(const std::string& content, const std::string& key) {
...
bool MultiRocketTestbenchLoader::load_model_to_hls_arrays(
...
bool MultiRocketTestbenchLoader::load_test_data(
